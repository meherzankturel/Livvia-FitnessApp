  ...
  return (
    ...
    >
      <View style={{ flex: 1, justifyContent: "center", paddingHorizontal: 24 }}>
        <Text style={{ color: "#F6F5F0", fontSize: 28, fontWeight: "700", marginBottom: 8 }}>
          Create Account
        </Text>
        <Text style={{ color: "rgba(246,245,240,0.5)", fontSize: 16, marginBottom: 40 }}>
        ...
        />
        <Text style={{ color: "rgba(246,245,240,0.3)", fontSize: 14, marginBottom: 24, paddingHorizontal: 4 }}>
        ...
        <Link href="/sign-in" asChild>
          <Pressable style={{ width: "100%", alignItems: "center", paddingVertical: 12 }}>
            <Text style={{ color: "rgba(246,245,240,0.5)", fontSize: 16 }}>
              ...
              <Text style={{ color: "#34D399", fontWeight: "600" }}>Sign In</Text>
            </Text>
          </Pressable>
        </Link>
      </View>

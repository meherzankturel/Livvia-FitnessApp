...
export const INDIAN_MEAL_TEMPLATES: MealTemplate[] = [
  ...
  // 1. Moong Dal Cheela
  {
    ...
    recipe: {
      ingredients: [
        { name: "Green moong dal (soaked 4 hrs)", amount: "1", unit: "cup", category: "lentils" },
        { name: "Onion (finely chopped)", amount: "1", unit: "small", category: "produce" },
  ...
  // 5. Dalia Khichdi (Broken Wheat Porridge)
  {
    ...
    recipe: {
      ingredients: [
        { name: "Dalia (broken wheat)", amount: "1/2", unit: "cup", category: "grains" },
  ...
  // 6. Paneer Bhurji with Roti
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (finely chopped)", amount: "1", unit: "medium", category: "produce" },
  ...
  // 7. Idli Sambar
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Toor dal", amount: "1/2", unit: "cup", category: "lentils" },
        ...
        { name: "Onion (chopped)", amount: "1", unit: "small", category: "produce" },
  ...
  // 10. Pesarattu (Green Moong Dosa)
  {
    ...
    recipe: {
      ingredients: [
        { name: "Whole green moong dal (soaked 6 hrs)", amount: "1", unit: "cup", category: "lentils" },
        ...
        { name: "Oil", amount: "1", unit: "tsp", category: "pantry" },
        { name: "Onion (finely chopped, for topping)", amount: "1", unit: "small", category: "produce" },
      ],
      steps: [
  ...
  // 11. Dal Tadka + Brown Rice + Cucumber Raita
  {
    ...
    recipe: {
      ingredients: [
        { name: "Toor dal", amount: "3/4", unit: "cup", category: "lentils" },
        { name: "Brown rice", amount: "1/2", unit: "cup (dry)", category: "grains" },
        { name: "Ghee", amount: "1", unit: "tsp", category: "dairy" },
        { name: "Cumin seeds", amount: "1/2", unit: "tsp", category: "spices" },
  ...
  // 12. Rajma Chawal
  {
    ...
    recipe: {
      ingredients: [
        { name: "Rajma (kidney beans, soaked overnight)", amount: "1", unit: "cup", category: "lentils" },
        { name: "Basmati rice", amount: "1/2", unit: "cup (dry)", category: "grains" },
        { name: "Onion (finely chopped)", amount: "1", unit: "large", category: "produce" },
        { name: "Tomato (pureed)", amount: "2", unit: "medium", category: "produce" },
  ...
  // 13. Chole + Multigrain Roti
  {
    ...
    recipe: {
      ingredients: [
        { name: "Kabuli chana (chickpeas, soaked overnight)", amount: "1", unit: "cup", category: "lentils" },
  ...
  // 15. Fish Curry + Steamed Rice
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (sliced)", amount: "1", unit: "medium", category: "produce" },
        { name: "Tomato (chopped)", amount: "1", unit: "medium", category: "produce" },
        { name: "Tamarind paste", amount: "1", unit: "tsp", category: "pantry" },
        { name: "Turmeric powder", amount: "1/4", unit: "tsp", category: "spices" },
        { name: "Red chili powder", amount: "1/2", unit: "tsp", category: "spices" },
  ...
  // 16. Palak Paneer + Roti
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (chopped)", amount: "1", unit: "medium", category: "produce" },
        { name: "Tomato (chopped)", amount: "1", unit: "small", category: "produce" },
        { name: "Ginger-garlic paste", amount: "1", unit: "tsp", category: "produce" },
  ...
  // 17. Mixed Sabzi + Dal + Roti
  {
    ...
    recipe: {
      ingredients: [
        { name: "Moong dal", amount: "1/2", unit: "cup", category: "lentils" },
  ...
  // 19. Grilled Tandoori Chicken + Salad
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (sliced into rings)", amount: "1", unit: "small", category: "produce" },
  ...
  // 20. Dal Palak + Multigrain Roti
  {
    ...
    recipe: {
      ingredients: [
        { name: "Masoor dal (red lentils)", amount: "3/4", unit: "cup", category: "lentils" },
  ...
  // 21. Paneer Tikka + Green Salad
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (cubed)", amount: "1", unit: "medium", category: "produce" },
        { name: "Tandoori masala", amount: "1", unit: "tbsp", category: "spices" },
        { name: "Ginger-garlic paste", amount: "1", unit: "tsp", category: "produce" },
        { name: "Lemon juice", amount: "1", unit: "tbsp", category: "produce" },
        { name: "Oil", amount: "1", unit: "tsp", category: "pantry" },
  ...
  // 22. Moong Dal Khichdi + Papad
  {
    ...
    recipe: {
      ingredients: [
        { name: "Basmati rice", amount: "1/2", unit: "cup", category: "grains" },
        { name: "Yellow moong dal", amount: "1/4", unit: "cup", category: "lentils" },
  ...
  // 24. Baingan Bharta + Roti
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Onion (finely chopped)", amount: "1", unit: "large", category: "produce" },
        { name: "Tomato (finely chopped)", amount: "2", unit: "medium", category: "produce" },
  ...
  // 26. Sprouts Chaat
  {
    ...
    recipe: {
      ingredients: [
        { name: "Mixed sprouts (moong, chana, moth)", amount: "1", unit: "cup", category: "lentils" },
        { name: "Onion (finely chopped)", amount: "1", unit: "small", category: "produce" },
        { name: "Tomato (finely chopped)", amount: "1", unit: "small", category: "produce" },
  ...
  // 28. Roasted Chana
  {
    ...
    recipe: {
      ingredients: [
        { name: "Kala chana (black chickpeas, roasted)", amount: "1", unit: "cup", category: "lentils" },
        { name: "Chaat masala", amount: "1/2", unit: "tsp", category: "spices" },
        { name: "Red chili powder", amount: "1/4", unit: "tsp", category: "spices" },
        { name: "Lemon juice", amount: "1", unit: "tsp", category: "produce" },
        { name: "Salt", amount: "to taste", unit: "", category: "pantry" },
  ...
  // 5. Goan Fish Curry + Rice
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Coriander powder", amount: "1", unit: "tsp", category: "spices" },
        { name: "Oil", amount: "1", unit: "tsp", category: "pantry" },
        { name: "Steamed rice", amount: "1/2", unit: "cup", category: "grains" },
        { name: "Salt", amount: "to taste", unit: "", category: "pantry" },
      ],
      steps: [
  ...
  // 11. Luchi with Cholar Dal
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Ghee", amount: "1", unit: "tsp", category: "dairy" },
        { name: "Chana dal", amount: "1/2", unit: "cup", category: "lentils" },
        { name: "Bay leaf", amount: "1", unit: "piece", category: "spices" },
        { name: "Cumin seeds", amount: "1/2", unit: "tsp", category: "spices" },
        { name: "Turmeric powder", amount: "1/4", unit: "tsp", category: "spices" },
  ...
  // 12. Pitha (Rice Flour Pancakes)
  {
    ...
    recipe: {
      ingredients: [
        { name: "Rice flour", amount: "1", unit: "cup", category: "grains" },
  ...
  // 13. Aloo Posto (Potatoes in Poppy Seed Paste)
  {
    ...
    cuisine: "indian_east",
    tags: ["vegetarian", "vegan"],
    ingredient_tags: ["potatoes", "poppy_seeds", "mustard_oil", "nigella_seeds"],
    recipe: {
      ingredients: [
        { name: "Potatoes", amount: "2", unit: "medium", category: "produce" },
  ...
  // 18. Aloo Dum (Bengali Style Spiced Baby Potatoes)
  {
    ...
    recipe: {
      ingredients: [
        ...
        { name: "Turmeric powder", amount: "1/4", unit: "tsp", category: "spices" },
        { name: "Sugar", amount: "1/2", unit: "tsp", category: "pantry" },
        { name: "Ghee or oil", amount: "1", unit: "tsp", category: "pantry" },
        { name: "Bay leaf", amount: "1", unit: "piece", category: "spices" },
        { name: "Garam masala", amount: "1/4", unit: "tsp", category: "spices" },
        { name: "Salt", amount: "to taste", unit: "", category: "pantry" },
      ],
